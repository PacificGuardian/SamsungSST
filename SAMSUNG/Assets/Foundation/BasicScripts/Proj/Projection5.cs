...
public class Projection5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //transform.localEulerAngles = OppTruePos.transform.eulerAngles;
        //transform.localEulerAngles = new Vector3(OppTruePos.transform.eulerAngles.x, OppTruePos.transform.eulerAngles.y, OppTruePos.transform.eulerAngles.z);
        //transform.eulerAngles = new Vector3(-90, 0, OppTruePos.transform.eulerAngles.z);
        Body.transform.localEulerAngles = OppTruePos.transform.eulerAngles;


        Body.transform.Rotate(0, 0, RotationZ + rR.eulerAngles.z);
